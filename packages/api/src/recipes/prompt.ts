...
Account for separately stated resting, chilling, marinating, cooling or other waiting time before subtracting; preserve those durations in notes and never count them as cooking or preparation. If the breakdown is ambiguous, the durations conflict, or subtraction would be negative, leave the missing time null. Do not split a total time when neither prep nor cook time is known.
